...
public class MuteHandler
{
    ...
    public static void initMutedChecker()
    {
     ...
     */
    public static boolean muteMember(Member member, int muteTimeSecs)
    {
        ...
        unmuteTimes.put(user, System.currentTimeMillis() + (muteTimeSecs * 1000));
